...
export GPC_CONSUMER_GPC_GET_DOCUMENT_PATH="/*/STU3/1/gpconnect/documents/Binary/**"
export GPC_CONSUMER_GPC_GET_PATIENT_PATH="/*/STU3/1/gpconnect/documents/Patient"
export GPC_CONSUMER_SEARCH_DOCUMENTS_PATH="/*/STU3/1/gpconnect/documents/fhir/Patient/**"
