...
public class FindPatientRouteTest extends CloudGatewayRouteBaseTest {
    private static final String SDS_FIND_PATIENT_URI_ENCODED = SDS_LOOKUP_URI + "Patient?identifier=https://fhir.nhs.uk/Id/nhs-number%7C9690937286";
    ...
    private static final String GPC_CONSUMER_FIND_PATIENT_URI_BASE = "/GP0001/STU3/1/gpconnect/documents/";
    private static final String GPC_CONSUMER_FIND_PATIENT_URI = GPC_CONSUMER_FIND_PATIENT_URI_BASE + "Patient?identifier=https://fhir.nhs.uk/Id/nhs-number|9690937286";
    ...
    public void When_MakingRequestForFindPatient_Expect_OkResponse() {
        WIRE_MOCK_SERVER.stubFor(get(urlEqualTo(SDS_FIND_PATIENT_URI_ENCODED))
        ...
        getWebTestClient().get()
            .uri(GPC_CONSUMER_FIND_PATIENT_URI)
