...
import uk.nhs.adaptors.gpc.consumer.filters.UrlsInResponseBodyRewriteFunction;
...
public class FindAPatientDocsTest {
    ...
    public void When_GPCBaseUrlPresentInBody_Expect_GPCConsumerBaseUrlReplacementInBody() {
        ...
        var replacedUrlBody = UrlsInResponseBodyRewriteFunction.replaceUrl(GPC_CONSUMER_BASE_URL, GPC_BASE_URL, response);
